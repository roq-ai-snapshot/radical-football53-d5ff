...
function HomePage() {
  return (
    <>
      <Head>
        <title>radical-football53</title>

        <meta
          name="description"
          content="Empower Your Players with Radical-Football53: The Ultimate Youth Soccer Academy Management Platform for Personalized Coaching and Accelerated Development."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              Empower Your Players with Radical-Football53: The Ultimate Youth Soccer Academy Management Platform for
